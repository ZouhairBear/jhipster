...
import tn.camelstudio.jhipster.repository.CategoryRepository;
import tn.camelstudio.jhipster.service.CategoryService;
import tn.camelstudio.jhipster.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link tn.camelstudio.jhipster.domain.Category}.
 */
@RestController
@RequestMapping("/api")
